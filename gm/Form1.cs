...
namespace gm
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)  //массивы положений
        {
            #region
            ringSmall[0, 0] = new Point(80, 456);    //1 столб 1 сверху
            ringSmall[0, 1] = new Point(80, 502);
            ringSmall[0, 2] = new Point(80, 548);
            ringSmall[1, 0] = new Point(472, 456);   //2 столб 1 сверху
            ringSmall[1, 1] = new Point(472, 502);
            ringSmall[1, 2] = new Point(472, 548);
            ringSmall[2, 0] = new Point(860, 456);   //3 столб 1 сверху
            ringSmall[2, 1] = new Point(860, 502);
            ringSmall[2, 2] = new Point(860, 548);

            ringMid[0, 0] = new Point(44, 502);    //1 столб 2 сверху
            ringMid[0, 1] = new Point(44, 548);
            ringMid[1, 0] = new Point(436, 502);   //2 столб 2 сверху
            ringMid[1, 1] = new Point(436, 548);
            ringMid[2, 0] = new Point(824, 502);   //3 столб 2 сверху
        ...
        private void label5_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                {
                    if (label1.Location == ringBig[i, 0] && label2.Location == ringMid[i, 0])
                    {
                    ...
                    else if (label1.Location != ringBig[i, 0] && label2.Location == ringMid[i, 1])
                    {
            ...
            if (label1.Location == ringBig[2, 0] && label2.Location == ringMid[2, 0] && label5.Location == ringSmall[2, 0])
            {
                timer.Stop();
        ...
        private void label2_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                if (currentLocMid < area1[i] && currentLocMid > area[i])
                {
                    ...
                    if (label5.Location != ringSmall[i, 1] && label1.Location == ringBig[i, 0])
                    {
                    ...
                    else if (label5.Location != ringSmall[i, 1]
                             && label1.Location != ringBig[i, 0]
                             && label5.Location != ringSmall[i, 2])
                    {
        ...
        {
            if (statusMid && columnSmall != columnMid)
            {
                #region
        ...
        private void label1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                {
                    if (label5.Location != ringSmall[i, 2] && label2.Location != ringMid[i, 1])
                    {
        ...
        {
            if (statusBig && columnSmall != columnBig && columnMid != columnBig)
            {
                #region
